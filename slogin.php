<?php
    ...
    if($_SERVER ["REQUEST_METHOD"]== "POST")
    {
        ...
        $sql = "select * from user_student where username='$usernm' and password='$pwd'";
      ...
      if($check>0)
      {
        ...
        session_start();
       $_SESSION["loggedin"] = 1;
       $_SESSION["sname"] = $usernm;
       $_SESSION["spwd"] = $pwd;
       header("location:Suser/swelcome.php");
...
<nav >
        <div class="containerfluid">
            <ul id="navbar">
                <h4 id="nav_heading">Student Login</h4>
            </ul>
...
<div class="col-md-7">
        ...
        <form action="slogin.php" method="post" onsubmit="return validate() "  id="loginform" name="loginform">
 ...
 <h6>Fill Login Details</h6>
        ...
        <strong ><a style="color:black"; href="studsignup.php" id="ssignuplink"> Create new account</a></strong>
